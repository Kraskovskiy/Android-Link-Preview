...
public class Regex {
	public static final String IMAGE_PATTERN = "(.+?)\\.(jpg|png|bmp|ico)$";
	public static final String IMAGE_TAG_PATTERN = "<img(.*?)src=(\"|')(.+?)(jpg|png|bmp)(\"|')(.*?)(/)?>(</img>)?";
	public static final String ICON_TAG_PATTERN = "<img(.*?)src=(\"|')(.+?)(jpg|png|bmp)(\"|')(.*?)(/)?>(</img>)?";
	public static final String ICON_REV_TAG_PATTERN = "<img(.*?)src=(\"|')(.+?)(jpg|png|bmp)(\"|')(.*?)(/)?>(</img>)?";
	public static final String ITEMPROP_IMAGE_TAG_PATTERN = "<img(.*?)src=(\"|')(.+?)(jpg|png|bmp)(\"|')(.*?)(/)?>(</img>)?";
	public static final String ITEMPROP_IMAGE_REV_TAG_PATTERN = "<img(.*?)src=(\"|')(.+?)(jpg|png|bmp)(\"|')(.*?)(/)?>(</img>)?";
	...
	public static final String URL_PATTERN = "<\\b(https?|ftp|file)://[-а-яёa-zА-ЯЁA-Z0-9+&@#/%?=~_|!:,.;]*[-а-яёa-zА-ЯЁA-Z0-9+&@#/%=~_|]>";
